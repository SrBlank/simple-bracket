...
async def delete_tournament(
    ...
    # Cascade-delete everything that references the tournament, in FK-safe order, so deleting
    # a tournament that has content actually works instead of erroring on a constraint.
